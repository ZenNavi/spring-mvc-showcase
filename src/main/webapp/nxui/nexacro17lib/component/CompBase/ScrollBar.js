...
if (!nexacro.ScrollBarControl) {
	...
	_pScrollBar.on_incbutton_lbuttondown = function (obj) {
		...
		if (pos >= max) {
			...
			this.pos = posarr[0];
			this._pos = posarr[1];
			this.on_fire_onscroll(this.pos, (this.direction == "vertical" ? "linedown" : "lineright"), undefined, undefined, this.direction);
	...
	_pScrollBar.on_decbutton_lbuttondown = function (obj) {
		...
		if (pos <= min) {
			...
			this.pos = posarr[0];
			this._pos = posarr[1];
			this.on_fire_onscroll(this.pos, (this.direction == "vertical" ? "lineup" : "lineleft"), undefined, undefined, this.direction);
