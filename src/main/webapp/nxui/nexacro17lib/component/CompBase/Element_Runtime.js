	...
	if (!nexacro.Element) {
		...
		_pElement.create = function (win) {
			...
			if (owner_elem && owner_elem.handle && !this.handle) {
				...
				var handle = nexacro.__createElementHandle(this, win_handle, this.left, this.top, this.width, this.height, this._getElementClassName(), this.name);
		...
		_pTextBoxElement.create = function (win) {
			...
			if (owner_elem && owner_elem.handle && !this.handle) {
				this.owner_elem = owner_elem;
				var win_handle = win.handle || owner_elem._getRootWindowHandle();
				var handle = nexacro.__createTextElementHandle(this, win_handle, this.left, this.top, this.width, this.height, this._getElementClassName(), this.name);
		...
		_pIconElement.create = function (win) {
			...
			if (owner_elem && owner_elem.handle && !this.handle) {
				this.owner_elem = owner_elem;
				var win_handle = win.handle || owner_elem._getRootWindowHandle();
				var handle = nexacro.__createIconTextElementHandle(this, win_handle, this.left, this.top, this.width, this.height, this._getElementClassName(), this.name);
		...
		_pIconTextElement.create = function (win) {
			...
			if (owner_elem && owner_elem.handle && !this.handle) {
				...
				var handle = nexacro.__createIconTextElementHandle(this, win_handle, this.left, this.top, this.width, this.height, this._getElementClassName());
		...
		_pImageElement.create = function (win) {
			...
			if (owner_elem && owner_elem.handle && !this.handle) {
				...
				var handle = nexacro.__createImageElementHandle(this, win_handle, this.left, this.top, this.width, this.height, "", "", false, true);
		...
		_pInputElement.create = function (win) {
			...
			if (owner_elem && owner_elem.handle && !this.handle) {
				...
				var handle = this.handle = nexacro.__createInputElementHandle(this, win_handle, this.left, this.top, this.width, this.height, this._getElementClassName(), this.name, true, false);
			...
			if (handle) {
				...
				if (!this._processing_oninput) {
					...
					if (prev_status == cur_status) {
						if ((this.value && this.value == value) || (!this.value && this.defaultvalue == value)) {
		...
		_pTextAreaElement.create = function (win) {
			...
			if (owner_elem && owner_elem.handle && !this.handle) {
				...
				var handle = this.handle = nexacro.__createInputElementHandle(this, win_handle, this.left, this.top, this.width, this.height, this._getElementClassName(), this.name, true, this.usemultiline);
		...
		_pControlElement.create = function (win) {
			if (!this._is_popup) {
				...
				if (owner_elem && owner_elem.handle && !this.handle) {
					...
					var handle = nexacro.__createControlElementHandle(this, win_handle, this.left, this.top, this.width, this.height, classname, this.name, this._is_control);
				...
				if (!this.handle) {
					...
					var handle = nexacro.__createControlElementHandle(this, win_handle, this.left, this.top, this.width, this.height, this._getElementClassName(), this.name, this._is_control);
		...
		_pControlElement._getComputedStyleSubValue = function (prop, subprop) {
			if (this.handle && prop && subprop) {
				return nexacro.__getElementHandleStyleSubValue(this.handle, prop, subprop);
			}
		};
		...
		_pControlElement.setElementSize = function (width, height, isInnerFrame) {
			if (this._type_name == "FrameControlElement") {
			...
			if (!this._is_popup) {
				...
				if (owner_elem && owner_elem.handle) {
					if (!this.handle) {
						...
						var handle = nexacro.__createScrollableControlElementHandle(this, win_handle, this.left, this.top, this.width, this.height, this._getElementClassName(), this.name, this._is_control);
				...
				if (!this.handle) {
					...
					var handle = nexacro.__createScrollableControlElementHandle(this, win_handle, this.left, this.top, this.width, this.height, this._getElementClassName(), linkedcontrol._unique_id, this._is_control);
		...
		__pContainerElement.create = function (win) {
			...
			if (owner_elem && owner_elem.handle && !this.handle) {
				...
				var win_handle = win.handle || owner_elem._getRootWindowHandle();
				var handle = nexacro.__createScrollableContainerElementHandle(this, win_handle, this.left, this.top, this.width, this.height, "nexacontainer", this.name);
		...
		_pPluginElement._on_plugin_event = function (evt_id, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) {
			var comp = (this.parent_elem ? this.parent_elem.linkedcontrol : null);
			if (comp && evt_id) {
				if (comp[evt_id]) {
						...
						try {
							for (i = 0; i < len; i++) {
								...
								if (obj.enableevent !== false) {
									ret = h.handler.call(h.target, obj, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
								}
							}
						}
						catch (e) {
