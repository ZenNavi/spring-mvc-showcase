...
if (!nexacro.TitleBarControl) {
	...
	_pTitleBarControl.on_create_contents = function () {
		...
		if (control_elem) {
			var titleicon = this.titleicon = new nexacro._TitleBarIconTextControl("titleicon", 0, 0, 0, 0, null, null, null, null, null, null, this);
			var minbutton = this.minbutton = new nexacro._TitleBarButtonControl("minbutton", 0, 0, 0, 0, null, null, null, null, null, null, this);
			var maxbutton = this.maxbutton = new nexacro._TitleBarButtonControl("maxbutton", 0, 0, 0, 0, null, null, null, null, null, null, this);
			var normalbutton = this.normalbutton = new nexacro._TitleBarButtonControl("normalbutton", 0, 0, 0, 0, null, null, null, null, null, null, this);
			var closebutton = this.closebutton = new nexacro._TitleBarButtonControl("closebutton", 0, 0, 0, 0, null, null, null, null, null, null, this);
