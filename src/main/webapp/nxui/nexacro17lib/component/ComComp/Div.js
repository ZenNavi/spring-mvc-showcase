		...
		while (node) {
			if (node.nodeType == 1) {
				...
				if (fnConstructor && fnConstructor.prototype && fnConstructor.prototype._is_component) {
					...
					var obj = new fnConstructor(attr["id"], attr["left"], attr["top"], attr["width"], attr["height"], attr["bottom"], attr["minwidth"], attr["maxwidth"], attr["minheight"], attr["maxheight"], this.form);
