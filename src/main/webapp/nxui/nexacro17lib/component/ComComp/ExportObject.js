...
if (!nexacro.ExcelExportObject) {
		...
		if (bodycntcell > 0) {
			...
			for (var k = this._startRow; k < partitionRow; k++) {
				...
				for (var j = 0; j < bodycntcell; j++) {
					...
					var is_line_changed = false, d_BLColor, left_linecolor = null, top_linecolor = null, right_linecolor = null, bottom_linecolor = null, linecolor;
	...
	_pExportItem._gridItemExport = function (exportObj) {
		...
		if (nexacro._Browser == "Runtime") {
			...
			madeformat = nexacro._replaceAll(this._makeFormat(grid), "&#13;", "");
		}
