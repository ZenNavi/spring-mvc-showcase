...
if (!nexacro.CellInfo) {
	...
	_pCellInfo._property_map = [["cssclass", null, true, "", true], ["displaytype", null, true, "normal", false], ["edittype", null, true, "none", false], ["tooltiptype", null, false, "default", false], ["tooltiptext", null, true, undefined, false], ["autosizecol", null, false, "default", false, 2, ["none", "limitmin", "limitmax", "default"]], ["autosizerow", null, false, "default", false, 2, ["none", "limitmin", "limitmax", "default"]], ["displayexpdec", null, true, -1, false, 0], ["locale", null, true, "", false], ["text", null, true, null, false], ["expr", null, true, null, false], ["subsumtext", null, true, "", false], ["controlautosizingtype", null, true, "both", false, 2, ["none", "width", "height", "both"]], ["checkboxsize", null, true, -1, false, 0], ["accessibilityaction", null, false, null, false], ["accessibilitydesclevel", null, false, "all", false], ["accessibilitydescription", null, false, null, false], ["accessibilityenable", null, true, true, false, 1], ["accessibilitylabel", null, true, null, false], ["accessibilityrole", null, false, "gridcell", false], ["color", null, false, null, true], ["font", null, false, null, true], ["wordSpacing", null, false, null, true], ["letterSpacing", null, false, null, true], ["textDecoration", null, false, null, true], ["wordWrap", null, true, null, true], ["borderRadius", null, false, null, true], ["border", null, false, null, true], ["background", null, false, null, true], ["edge", null, false, null, true], ["cursor", null, false, null, true], ["opacity", null, false, null, true], ["boxShadow", null, false, null, true], ["padding", null, false, null, true], ["textAlign", null, false, null, true], ["verticalAlign", null, false, null, true]
	];
...
if (!nexacro._CellControl) {
	...
	_pCellControl._apply_normalstyleFromInfo = function () {
		...
		for (var i = 0, n = normal_prop.length; i < n; i++) {
			if ((normal_prop[i][nexacro._CELLINFO_PMAP_STYLE] == true) || (normal_prop[i][nexacro._CELLINFO_PMAP_PROPNAME].substring(0, 13) == "accessibility")) {
				prop = normal_prop[i][nexacro._CELLINFO_PMAP_PROPNAME];
	...
	_pCellControl.on_destroy_contents = function () {
		...
		if (this._tempdestroyeditor_list) {
			for (var i = 0; i < this._tempdestroyeditor_list.length; i++) {
	...
	_pCellEdit._setAccessibilityStatFocus = function () {
		...
		if (!this._displaymode) {
			this._input_element._setAccessibilityLabel(label + cellobj._getAccessibilityReadLabel(false));
		}
	...
	_pCellCalendar._setAccessibilityStatFocus = function () {
		...
		label = label.trim();
		this._setAccessibilityInputLabel(addlabel + " " + cellobj._getAccessibilityReadLabel(false));
		this._setAccessibilityLabel(label);
		nexacro.Component.prototype._setAccessibilityStatFocus.call(this);
	};
	...
	_pCellTree._adjustSubCompAlign = function (level) {
		...
		for (var i = 0; j < left_lines_len; i++) {
			if (parentlevel == left_lines[j]._depth) {
				var elem = left_lines[j++]._control_element;
		...
		if (this._btnimg_ctrl) {
			...
			if (buttonHeight <= 0) {
				buttonWidth = this._btnimg_ctrl._tmph;
			}
		...
		if (this._downline_ctrl && this._downline_ctrl.visible) {
			var elem = this._downline_ctrl._control_element;
