...
if (!nexacro.Tab) {
	...
	_pTab.insertTabpage = function (strId, nIndex, strUrl, strText, tabbuttonwidth, tabbuttonheight) {
		...
		var newtabbtn = this._tabbutton_obj = tabbuttonitems[idx] = this._createTabbutton(idx, tabpage, false);
...
if (!nexacro.Tabpage) {
	...
	_pTabpage._is_loadedform = false;
	...
	_pTabpage._loadedForm = function () {
